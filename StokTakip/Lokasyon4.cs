...
namespace StokTakip
{
    public partial class Lokasyon4 : Form
    {
        public Lokasyon4()
        {
            InitializeComponent();
        ...
        private void Lokasyon4_Load(object sender, EventArgs e)
        {
            timer1.Start();

            var wh = from item in db.WarehouseTB
                     where (item.W_Id == 3 || item.W_Id == 8)
        ...
        private void dtgvLokasyon4_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            txtUrubid.Text = dtgvLokasyon4.CurrentRow.Cells[0].Value.ToString();
        }
        ...
        public void Listele()
        {
            ...
            dtgvLokasyon4.DataSource = it.ToList();
            dtgvLokasyon4.Columns[0].HeaderText = "Ürün İd";
            dtgvLokasyon4.Columns[1].HeaderText = "Ürün Adı";
            dtgvLokasyon4.Columns[2].HeaderText = "Ürün Adet";
            dtgvLokasyon4.Columns[3].HeaderText = "Ürün Raf";
        }
        ...
        private void Lokasyon4_FormClosing(object sender, FormClosingEventArgs e)
        {
