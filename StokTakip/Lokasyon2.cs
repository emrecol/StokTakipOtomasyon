...
namespace StokTakip
{
    public partial class Lokasyon2 : Form
    {
        public Lokasyon2()
        {
            InitializeComponent();
        ...
        private void Lokasyon2_Load(object sender, EventArgs e)
        {
            timer1.Start();

            var wh = from item in db.WarehouseTB
                     where (item.W_Id == 1 || item.W_Id == 6)
        ...
        private void dtgvLokasyon2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            txtUrubid.Text = dtgvLokasyon2.CurrentRow.Cells[0].Value.ToString();
        }
        ...
        public void Listele()
        {
            ...
            dtgvLokasyon2.DataSource = it.ToList();
            dtgvLokasyon2.Columns[0].HeaderText = "Ürün İd";
            dtgvLokasyon2.Columns[1].HeaderText = "Ürün Adı";
            dtgvLokasyon2.Columns[2].HeaderText = "Ürün Adet";
            dtgvLokasyon2.Columns[3].HeaderText = "Ürün Raf";
        }
        ...
        private void Lokasyon2_FormClosing(object sender, FormClosingEventArgs e)
        {
